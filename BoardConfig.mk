...
TW_SUPPORT_INPUT_AIDL_HAPTICS := flase
...
TW_LOAD_VENDOR_DLKM_MODULES := $(shell echo \"$(shell ls $(DEVICE_PATH)/recovery/root/vendor_dlkm/lib/modules)\")
